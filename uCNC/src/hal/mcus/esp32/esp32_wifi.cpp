...
#define MAX_SRV_CLIENTS 1
	...
	uint8_t esp32_wifi_cmd(uint8_t *grbl_cmd_str, uint8_t grbl_cmd_len, uint8_t next_char)
	{

#ifdef BOARD_HAS_CUSTOM_SYSTEM_COMMANDS
		uint8_t str[64];
		uint8_t arg[WIFI_SSID_MAX_LEN];
...
#else
	uint8_t esp32_wifi_cmd(uint8_t *grbl_cmd_str, uint8_t grbl_cmd_len, uint8_t next_char) { return STATUS_INVALID_STATEMENT; }
	void esp32_wifi_init(void) {}
	void esp32_wifi_process(void) {}
#endif
}
