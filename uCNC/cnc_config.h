...
#define N_ARC_CORRECTION 16
	...
	#define DEFAULT_STEP_PER_MM_PER_AXIS {80, 80, 400}
	// #define DEFAULT_MAX_FEED 500
	#define DEFAULT_MAX_FEED_PER_AXIS {400, 400, 50}
	// #define DEFAULT_ACCEL 10
	#define DEFAULT_ACCEL_PER_AXIS {2000, 2000, 100}
	// #define DEFAULT_MAX_DIST 200
	#define DEFAULT_MAX_DIST_PER_AXIS {300, 300, 200}
